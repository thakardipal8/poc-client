...
const NextPayrollTotalWidget = () => {
  ...
  return (
    <div>
      <h1 className="section-heading-overview">Upcoming Payroll Summary</h1>
...
export default NextPayrollTotalWidget;
